...
"""
────────────────────────────────────────────
\033[7m\033[33m   MrGhostOfficial[Nethantara CyberCoder TeM]   \033[00m
────────────────────────────────────────────
<---- Auto Compile Script ---->
...
{ 11 } Obfuscate By MrGhost 1
{ 12 } Obfuscate By MrGhost 2
{ 13 } Obfuscate By MrGhost 3 [ Fix ]
{ 14 } Obfuscate By MrGhost 4 [ Fix ]
{ 15 } Encode rot_13
{ 16 } Encode cp424
{ 17 } Encode bz2_codec
{ 18 } Encode utf_32_le
...
"""
	...
	def CHOSEE(self):
		...
		if self.CHOSE == "1" or self.CHOSE == "01":
			...
			exit("[+] thanks for using my tools bye!")
		else:
