...
#T̂͗̋͛̏ͨ̚͜a͍͚͖͙̞̰̔ͣͩ̈̍̅̑a͈͍̐͛̎̑́͐r͏͉̖̙̲̘͎͇m̴̪ͯ̌o̰̼͔̪͈̺̟ͤ͌̓s̡͙̪̣͚̮̠͇̈
from sys import stdout
import subprocess as sp
import os, sys, time, random, base64, marshal, getpass, re, zlib, tarfile, shutil
...
def run(x):
    ...
    try:
        ...
        #T̂͗̋͛̏ͨ̚͜a͍͚͖͙̞̰̔ͣͩ̈̍̅̑a͈͍̐͛̎̑́͐r͏͉̖̙̲̘͎͇m̴̪ͯ̌o̰̼͔̪͈̺̟ͤ͌̓s̡͙̪̣͚̮̠͇̈
def checkxvzf():
    tarball = os.path.expanduser("~/Enc_DecCode/AGITFOLDER.tar.gz")
    extract_dir = os.path.expanduser("~/Enc_DecCode/")
    ...
    try:
        ...
        tar.close()
        os.remove(tarball)
        print("Server extracted and archive removed.")
...
def allin1_install():
    ...
    print ("{}[{}INFO{}] {}>> {}if you already using my restore termux file this {}https://github.com/MrGhostOfficial/TermuxRestore {}then don't need to install again.{}").format(bluelite,cyanlite,bluelite,redlite,cyanlite,whitelite,cyanlite,finished)
    print ""
    print ("{}[{}i{}] {}>> {}pkg installing update -y{}").format(bluelite,greenlite,bluelite,redlite,greenlite,finished)
    os.system('apt update')
    print ""
    os.system('cd $HOME;neofetch --ascii_distro Arch')
...
def updatetool():
        ...
        time.sleep(10)
        os.system('rm -rf $HOME/Enc_DecCode;cd $HOME;git clone https://github.com/MrGhostOfficial/Enc_DecCode.git;cd ~/Enc_DecCode;chmod +x Script.py;bash $PREFIX/share/ighost/ghost.update;ls')
        time.sleep(2)
        sys.exit()
       #T̂͗̋͛̏ͨ̚͜a͍͚͖͙̞̰̔ͣͩ̈̍̅̑a͈͍̐͛̎̑́͐r͏͉̖̙̲̘͎͇m̴̪ͯ̌o̰̼͔̪͈̺̟ͤ͌̓s̡͙̪̣͚̮̠͇̈
def telegram():
